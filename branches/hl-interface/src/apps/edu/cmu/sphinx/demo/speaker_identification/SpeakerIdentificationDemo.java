package edu.cmu.sphinx.demo.speaker_identification;

import java.io.FileWriter;
import java.io.IOException;
import java.util.ArrayList;
import edu.cmu.sphinx.diarization.*;
...
public class SpeakerIdentificationDemo {
    ...
    public static void main(String[] args) throws IOException {
        String inputFile = "src/apps/edu/cmu/sphinx/demo/speaker_identification/librivox_community_podcast_135.wav";

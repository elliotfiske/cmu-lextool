...
public class GrammarAligner implements Aligner {
    ...
    public GrammarAligner(URL acousticModel, URL dictionary, URL g2p)
        throws PropertyException, MalformedURLException
    {
        URL url = resourceToURL("resource:/edu/cmu/sphinx/config/aligner.xml");
    ...
    @Override
    public List<WordResult> align(AudioInputStream stream, String text) {

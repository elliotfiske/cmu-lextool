...
import os, sys, time, struct, socket, traceback, multitask, amf, hashlib, hmac, random, subprocess
...
class FLV(object):
    ...
    def close(self):
        ...
        if self.fp is not None: 
            ...
            self.fp = None
        # if recording, convert the FLV to wav file using ffmpeg
        if self.type == 'record' and self.tsr0 is not None:
            if _debug: print 'converting flv file to wav'

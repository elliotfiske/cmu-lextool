...
static bit_adress_t middle_find(middle_t *middle, word_idx word, node_range_t *range)
{
    ...
    range->begin = read_int31(middle->base.base, bit_offset, middle->next_mask.bits, middle->next_mask.mask);
    range->end = read_int31(middle->base.base, bit_offset + middle->base.total_bits, middle->next_mask.bits, middle->next_mask.mask);
